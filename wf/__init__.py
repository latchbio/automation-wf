...
def automation_workflow(input_directory: LatchDir) -> None:
    output_directory = LatchOutputDir(
        path="FIXME"  # fixme: change to latch:// path of desired output directory
    )

    # See screenshots of where to find `target_wf_id`` and `table_id`` at this link <https://docs.latch.bio/automation/automation-usecase.html>
    automation_task(
